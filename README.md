...
> 5-class network intrusion detection on the NSL-KDD dataset using federated deep learning (MLP, RNN, LSTM) distributed with Apache Spark, benchmarked against classical ML baselines.
